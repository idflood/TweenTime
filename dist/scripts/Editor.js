...
// Generated by CoffeeScript 1.8.0
(function() {
  define('cs!graph/Keys',['require','d3','Signal','cs!core/Utils'],function(require) {
    var Keys, Signals, Utils, d3;
    d3 = require('d3');
    Signals = require('Signal');
    Utils = require('cs!core/Utils');
...
(function() {
  ...
  define('cs!graph/Timeline',['require','jquery','d3','Signal','cs!core/Utils','cs!graph/Header','cs!graph/TimeIndicator','cs!graph/Items','cs!graph/Properties','cs!graph/Keys','cs!graph/Errors'],function(require) {
...
(function() {
  ...
  define('cs!editor/PropertiesEditor',['require','jquery','lodash','Signal','cs!editor/PropertyNumber','cs!editor/PropertyTween','text!templates/propertiesEditor.tpl.html'],function(require) {
    ...
    return PropertiesEditor = (function() {
      ...
      PropertiesEditor.prototype.onSelect = function(selectedObject, data, propertyData, d3Object) {
        var $actions, $remove_bt, instance_prop, key, prop, property_name, tween, type_properties, _ref;
        if (data == null) {
          data = false;
        }
        ...
        if (selectedObject.label) {
          this.$container.append('<h2 class="properties-editor__title">' + selectedObject.label + '</h2>');
        }
        if (selectedObject.classObject) {
          ...
          _ref = selectedObject.properties;
          for (key in _ref) {
...
(function() {
  ...
  define('cs!editor/Editor',['require','text!templates/timeline.tpl.html','cs!graph/Timeline','cs!editor/PropertiesEditor','cs!editor/EditorMenu','cs!editor/EditorControls'],function(require) {
    var Editor, EditorControls, EditorMenu, PropertiesEditor, Timeline, tpl_timeline;
    ...
    return Editor = (function() {
      function Editor(tweenTime, options) {
        ...
        this.timeline = new Timeline(this.tweenTime);
