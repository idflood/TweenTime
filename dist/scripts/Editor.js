...
(function() {
  ...
  define('cs!graph/Timeline',['require','jquery','d3','cs!core/Utils','cs!graph/Header','cs!graph/TimeIndicator','cs!graph/Items','cs!graph/Properties','cs!graph/Keys','cs!graph/Errors','cs!graph/Selection'],function(require) {
    var $, Errors, Header, Items, Keys, Properties, Selection, TimeIndicator, Timeline, Utils, d3, extend;
    $ = require('jquery');
    d3 = require('d3');
    Utils = require('cs!core/Utils');
  ...
  define('cs!editor/SelectionManager',['require','Signal'],function(require) {
    ...
    return SelectionManager = (function() {
      ...
      SelectionManager.prototype.select = function(item, addToSelection) {
        ...
        return this.onSelect.dispatch(item, addToSelection);
      };
