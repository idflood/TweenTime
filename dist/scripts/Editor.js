...
(function() {
  ...
  define('cs!editor/Editor',['require','text!templates/timeline.tpl.html','cs!graph/Timeline','cs!editor/PropertiesEditor'],function(require) {
    var Editor, PropertiesEditor, Timeline, tpl_timeline;
      ...
      Editor.prototype.initAdd = function() {
        ...
        return $container.find('a').click(function(e) {
          ...
          if (ElementFactory.elements[element_name]) {
            ...
            return self.timeline.isDirty = true;
          }
        });
      };
