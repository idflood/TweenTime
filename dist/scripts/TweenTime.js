...
(function() {
  ...
  define('cs!core/Timer',['require','Signal'],function(require) {
    var Signals, Timer;
...
(function() {
  ...
  define('cs!core/Orchestrator',['require','Signal','TweenMax','TimelineMax'],function(require) {
    var Orchestrator, Signals, TimelineMax, TweenMax;
    Signals = require('Signal');
...
(function() {
  ...
  define('cs!core/TweenTime',['require','lodash','cs!core/Utils','cs!core/Timer','cs!core/Orchestrator'],function(require) {
    var Orchestrator, Timer, TweenTime, Utils, _;
    _ = require('lodash');
    ...
    return TweenTime = (function() {
      ...
      TweenTime.prototype.getItem = function(item_id) {
      ...
      TweenTime.prototype.getProperty = function(prop_name, item_id_or_obj) {
      ...
      TweenTime.prototype.getValues = function(item_id_or_obj) {
        item_id_or_obj = this.getItem(item_id_or_obj);
        if (!item_id_or_obj) {
          return void 0;
        }
      ...
      TweenTime.prototype.getValue = function(prop_name, item_id_or_obj) {
        var values;
      ...
      TweenTime.prototype.getKeyAt = function(property, time_in_seconds) {
        return _.find(property.keys, function(key) {
          return key.time === time_in_seconds;
        });
      };

      TweenTime.prototype.setValue = function(property, new_val, time_in_seconds) {
        var key;
...
define('TweenTime',['cs!core/TweenTime'], function (TweenTime) {
  return TweenTime;
});
...
//# sourceMappingURL=TweenTime.js.map