(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("lodash"), require(undefined), require("jquery"), require("d3"), require("spectrum"), require("mustache"), require("DraggableNumber"));
	else if(typeof define === 'function' && define.amd)
		define(["lodash", "signals", "jquery", "d3", "spectrum", "mustache", "DraggableNumber"], factory);
	else if(typeof exports === 'object')
		exports["Editor"] = factory(require("lodash"), require("./signals"), require("jquery"), require("d3"), require("spectrum"), require("mustache"), require("DraggableNumber"));
	else
		root["TweenTime"] = root["TweenTime"] || {}, root["TweenTime"]["Editor"] = factory(root["_"], root["signals"], root["$"], root["d3"], root["spectrum"], root["Mustache"], root["DraggableNumber"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tpl_timeline = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = (function () {
	  ...
	  Header.prototype.createTimeHandle = function () {
	    ...
	    var timeClicker = timeSelection.enter().append("rect").attr("x", 0).attr("y", 20).attr("width", self.xDisplayed(self.timer.totalDuration)).attr("height", 50).attr("fill-opacity", 0).on("click", function (d) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Items = (function () {
	  ...
	  Items.prototype.render = function () {
	    ...
	    var dragLeft = d3.behavior.drag().origin(function (d) {
	      var t = d3.select(this);
	      return { x: t.attr("x"), y: t.attr("y") };
	    }).on("drag", dragmoveLeft);
	
	    var dragRight = d3.behavior.drag().origin(function (d) {
	      var t = d3.select(this);
	      return { x: t.attr("x"), y: t.attr("y") };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KeysPreview = (function () {
	  ...
	  KeysPreview.prototype.render = function (bar) {
	    ...
	    var subGrp = properties.enter().append("svg").attr("class", "keys-preview timeline__right-mask").attr("width", window.innerWidth - self.timeline.label_position_x).attr("height", self.timeline.lineHeight);
	    ...
	    var key_item = keys.enter().append("path").attr("class", "key--preview").attr("style", setItemStyle).attr("d", "M 0 -4 L 4 0 L 0 4 L -4 0");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Errors = (function () {
	  ...
	  Errors.prototype.render = function (properties) {
	    ...
	    var errorsGrp = subGrp.insert("svg", ":first-child").attr("class", "line-item__errors").attr("width", window.innerWidth - self.timeline.label_position_x).attr("height", self.timeline.lineHeight);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PropertyNumber = (function (PropertyBase) {
	  ...
	  PropertyNumber.prototype.render = function () {
	    ...
	    var onChangeEnd = function (new_val) {
